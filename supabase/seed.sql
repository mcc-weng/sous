...
- 一律使用繁體中文回覆(即使對方用英文,除非他們明確要求英文)。$$,
  '{"app_subtitle": "你的私廚,在口袋裡", "auth_privacy_note": "我們只存你家的口味與菜單", "auth_promise": "小當家會記住你家的口味、排好這一週,然後在爐邊陪你把它煮出來。", "book_title": "私廚手記", "cook_milestone_reaction": "哇,這是你第 {n} 次做這道菜了!越來越上手了呢 🔥", "empty_book": "這本書還沒有第一道菜", "failure_message": "可惡…廚房出了點狀況,再讓我試一次。", "inbox_title": "與小當家的往來", "lock_hero": "這一週,我來安排", "lock_signoff": "放心去過你的一週", "offline_note": "打勾照樣有效,回到訊號範圍我再同步。", "onboarding_complete": "都記住了!以後煮菜通通照你的喜好來,想到什麼隨時再跟我說一聲 🔥", "onboarding_intro": "歡迎加入我的廚房!先讓我認識你一下,幾個小問題,一下就好 🔥", "onboarding_q_allergies": "你有沒有什麼過敏原,我要小心別放進菜單裡?", "onboarding_q_dislikes": "有沒有什麼你不喜歡吃的?我幫你避開。", "onboarding_q_equipment": "家裡有哪些廚房設備?", "onboarding_q_household_size": "平常煮飯大概幾人份?", "onboarding_q_spice": "口味吃辣嗎?", "presence_in": "在廚房", "presence_out": "外出中", "ritual_invite": "該排下週的菜單了,陪我聊幾句就好。", "ritual_prompt_body": "小當家在廚房等你 — 一起想想下週想吃什麼,幫大家排出幸福的一週!", "ritual_prompt_title": "該規劃下週菜單囉!🔥", "thinking_stages": ["看菜單…", "配菜…", "寫清單…"], "wait_leave_ok": "你可以先去忙 —— 排好我會放進便條通知你。"}'::jsonb
);
